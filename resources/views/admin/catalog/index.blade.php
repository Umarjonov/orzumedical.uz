            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Каталог</h6>
                    ...
                    @can('catalog.create')
                        <div class="col-lg-6 col-5 text-right">
                            <a href="{{ route('catalog.create') }}" class="btn btn-sm btn-neutral">
                                    ...
                                    <th scope="row">
                                        <div class="media align-items-center">
                                            <a href="#" class="avatar rounded-circle mr-3">
                                                <img alt="Image placeholder" src="{{asset('uploads/catalogs/'.$catalog->image)}}">
                                            </a>
                                            <div class="media-body">
                                                <span class="name mb-0 text-sm">{{ $catalog->name }}</span><br>
                                            </div>
                                        </div>
                                    </th>
                                    <td>{{ $catalog->parent_id ? $catalogs->find($catalog->parent_id)->name : 'asosiy' }}</td>
                                    <td>
										<span class="badge badge-dot mr-4">
                                            <i class="bg-{{ $catalog->is_active ? 'success' : 'warning' }}"></i>
                                            <span class="status">{{ $catalog->is_active ? 'active' : 'in_active' }}</span>
                                        </span>
                                    </td>
