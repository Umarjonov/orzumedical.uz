                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('branches.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="address_uz" type="text"
                                       class="input form-control {{ $errors->has('address_uz') ? "is-invalid":"" }}"
                                       value="{{ old('address_uz') }}" id="address_uz" placeholder="address_uz" aria-label="address_uz"
                                       aria-describedby="basic-addon1" required/>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="address_ru" type="text"
                                       ...
                                       value="{{ old('address_ru') }}" id="address_ru" placeholder="address_ru" aria-label="address_ru"
                                       aria-describedby="basic-addon1" required/>
