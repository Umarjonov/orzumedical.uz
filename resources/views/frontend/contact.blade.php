...
@section('content')
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Har Qanday So'rov Uchun Murojaat Qiling</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col mb-5">
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-0"><i class="fa fa-phone text-primary mr-3"></i>+998(99)616-85-58</p>
                    <p class="mb-0"><i class="fa fa-phone text-primary mr-3"></i>+998(99)975-18-88</p>
                    <p class="mb-0"><i class="fa fa-phone text-primary mr-3"></i>+998(91)772-17-28</p>
                </div>
