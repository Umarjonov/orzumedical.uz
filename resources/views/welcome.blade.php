    ...
    <div class="row px-xl-5 pb-3">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                ...
                <h5 class="font-weight-semi-bold m-0">Doimiy qo'llab quvvatlash</h5>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 border-hover mb-4 h-100">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="{{route('product.details',$product->id)}}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>batafsil ko'rish</a>
                    </div>
                </div>
            </div>
        @endforeach
