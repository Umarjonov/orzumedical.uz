...
<section class="absolute z-50 w-full top-0"> <!-- Header absolute qilindi -->
    <header class="relative bg-[#4A9F50] text-white py-[14px] text-sm block lg:hidden">
        <div class=" max-w-7xl mx-auto flex flex-wrap items-center justify-between px-4">
            ...
            <a href="#" class="flex items-center justify-center">
                <img src="./images/logo-nav.svg" alt="Orzu Medical Logo" class="w-[120px]" />
            </a>
        ...
        <div class="max-w-6xl mx-auto flex items-center justify-between px-4">
            ...
            <div class="hidden lg:flex items-center space-x-6">
                <button class="lang-btn bg-white text-[#4A9F50] hover:opacity-80 px-2 py-1 rounded">
                    <img src="./images/uz.svg" alt="UZ" class="w-8 h-6">
                </button>
                <button class="lang-btn px-2 py-1 rounded hover:opacity-80">
                    <img src="./images/ru.svg" alt="RU" class="w-8 h-6">
                </button>
                <button class="lang-btn px-2 py-1 rounded hover:opacity-80">
                    <img src="./images/en.svg" alt="EN" class="w-8 h-6">
                </button>
            </div>
        </div>
    </header>
    ...
    <nav class="bg-white max-w-6xl mx-auto shadow-sm rounded-lg  mt-[31px] px-7 hidden lg:block">
        <div class=" w-full   py-[15.5px]  flex items-center justify-between nano-sans">
            ...
            <a href="#" class="text-xl font-bold text-[#4A9F50]">
                <img src="./images/logo-nav.svg" alt="Logo icon">
            </a>
    ...
    <nav id="mobile-menu" class="lg:hidden hidden w-full h-screen overflow-hidden z-20 bg-white py-6">
        ...
        <div class="flex justify-around items-center py-4 bg-white">
            <button class="lang-btn bg-white border border-gray-300 px-2 py-1 rounded">
                <img src="./images/uz.png" alt="UZ" class="w-8 h-6" />
            </button>
            <button class="lang-btn border border-gray-300 px-2 py-1 rounded">
                <img src="./images/ru.png" alt="RU" class="w-8 h-6" />
            </button>
            <button class="lang-btn border border-gray-300 px-2 py-1 rounded">
                <img src="./images/en.jpg" alt="EN" class="w-8 h-6" />
            </button>
        </div>
    </nav>
</section>
...
<!-- About -->
<section
    class="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between pt-24 lg:pt-[190px] pb-[100px] px-4">
    ...
    <div
        ...
        <!-- Odam rasmi no-bg -->
        <img src="./images/odam.png" alt="Odam rasmi"
        ...
        <div
            ...
            <img src="./images/miyya.png" alt="Ikon" class="w-[29px] h-[31px] object-contain ml-2">

            <!-- Yozuv -->
            <span class="text-gray-700 w-[130px] text-[14px] ml-4 text-wrap">More
                    than 10K
                    Patients
                    treated!</span>
        </div>
    ...
    <div class="w-full lg:w-[544px]">
        ...
        <p class="nano-sans text-sm sm:text-base text-black leading-[22px] sm:leading-[24px]">
            "Yaxshi shifokor kasallikni davolaydi, buyuk shifokor esa organizmni
            sog'lom qiladi" — Uilyam Osler tomonidan aytilgan bu mashhur iqtibos
            Orzu Medicalda o'z ifodasini topgan. Chunki biz faqatgina ma'lum bir
            kasallikni emas, butun organizmni davolashga ixtisoslashganmiz.
        </p>
        <p class="nano-sans text-sm sm:text-base text-black leading-[22px] sm:leading-[24px] mt-5">
            Klinikamiz 20 yildan ortiq vaqt davomida minglab kishilarning sog'lom
...
<section id="orzu-medical" class="bg-white w-full">
    <div class="max-w-6xl mx-auto bg-white pt-[94px] pb-[100px] px-4">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-[150px]">
            <img class="w-full max-w-[386px] h-auto mb-6 lg:mb-0 hidden md:block" src="./images/orzu-Medical_1.png"
                 alt="Orzu medical humans" />

            <section class="w-full">
                <div class="space-y-[38px]">
                    <div class="flex items-start gap-4">
                        <img class="w-10 h-10" src="./images/batery.svg" alt="Battery icon" />
                    ...
                    <div class="flex items-start gap-4">
                        <img class="w-10 h-10" src="./images/heard.svg" alt="Heart icon" />
                        <div class="max-w-[322px]">
                            ...
                            <p class="nano-sans text-base leading-[21.79px]">Современные методики комплексного
                                очищения организма</p>
                        </div>
                    </div>

                    <div class="flex items-start gap-4">
                        <img class="w-10 h-10" src="./images/nurse.svg" alt="Nurse icon" />
                        <div class="max-w-[322px]">
        ...
        <div class="flex flex-col lg:flex-row items-center mt-[64px]">
            <section class="w-full lg:w-[57%]">
                <div class="space-y-[38px]">
                    <div class="flex items-start gap-4">
                        <img class="w-10 h-10" src="./images/hot Meal.svg" alt="Hot meal icon" />
                        <div class="max-w-[322px]">
                    ...
                    <div class="flex items-start gap-4">
                        <img class="w-10 h-10" src="./images/medical Symbol.svg" alt="Medical symbol icon" />
                        <div class="max-w-[322px]">
                    ...
                    <div class="flex items-start gap-4">
                        <img class="w-10 h-10" src="./images/hospital Symbol.svg" alt="Hospital symbol icon" />
                        <div class="max-w-[322px]">
            ...
            <img class="w-full max-w-[386px] h-auto hidden md:block" src="./images/orzu-Medical_2.png"
                 alt="Orzu medical 2" />
        </div>
    </div>
</section>
...
<div id="about" class="bg-[#ffffff] pt-[70px] pb-[100px]">
    <section class="max-w-7xl mx-auto p-6 bg-white">
        ...
        <p
            class="text-[#302E2E] max-w-[955px] mb-6 noto-sans text-[20px] font-medium leading-[27px] tracking-[0px] ">
        ...
        <h3 class="font-black noto-serif text-[32px] mt-[56px] mb-6">Bemorlarimiz fikrlari</h3>
...
<div id="filiallar" class="max-w-7xl mx-auto py-24 px-6 bg-[#f8f9fe]">
    ...
    <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
        <li class="bg-white p-6 rounded-lg w-full">
            <img class="w-full h-48 object-cover rounded-md" src="./images/filial.png" alt="Filial Image" />
...
<div id="xizmatlar" class="max-w-7xl mx-auto items-center pb-[100px] p-6 bg-[#f8f9fe]">
    ...
    <div class="bg-gray-50 p-8  rounded-lg max-w-7xl mx-auto flex items-center flex-col lg:flex-row gap-10">
        ...
        <div class="flex-1 space-y-6">
            <img src="./images/dastur icon.svg" alt="Icon logo">
            ...
            <ul class="space-y-3 text-gray-700">
                <li class="flex items-start space-x-2">
                    <img src="./images/galochka.svg" alt="galochka icon">
        ...
        <div class="flex-[1.5] flex flex-wrap gap-4">
            <div class="bg-white p-6 rounded-2xl shadow-md space-y-2 w-full lg:w-[48%]">
                ...
                <p class="noto-sans text-[#4A9F50] font-medium !mt-[16px]">396 000 so'm dan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-md space-y-2 w-full lg:w-[48%]">
                ...
                <p class="noto-sans text-[#4A9F50] font-medium !mt-[16px]">420 000 so'm dan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-md space-y-2 w-full lg:w-[48%]">
                ...
                <p class="noto-sans text-[#4A9F50] font-medium !mt-[16px]">410 000 so'm dan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-md space-y-2 w-full lg:w-[48%]">
                ...
                <p class="noto-sans text-[#4A9F50] font-medium !mt-[16px]">400 000 so'm dan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-md space-y-2 w-full lg:w-[48%]">
                ...
                <p class="noto-sans text-[#4A9F50] font-medium !mt-[16px]">390 000 so'm dan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-md space-y-2 w-full lg:w-[48%]">
                ...
                <p class="noto-sans text-[#4A9F50] font-medium !mt-[16px]">385 000 so'm dan</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-md space-y-2 w-full lg:w-[48%]">
                <h3 class="font-semibold text-lg">Bektemir filiali</h3>
                <p class="noto-sans font-medium text-lg text-[#979797]">Bektemir tumani, 8-uy</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div class="space-y-6">
            ...
            <p class="noto-sans text-xl text-[#000000]">
                Ushbu dastur o’z ichiga quyidagilarni oladi Lorem Ipsum is simply
                dummy text of the
            </p>
            <div class="space-y-4">
                <div class="flex items-center space-x-3 ">
                    <div class="bg-green-600 text-green-600 py-[8px] px-[6px] rounded-full">
                        <img class="w-[13px] h-[11px]" src="./images/gmail-Photoroom.svg" alt="gmail logo">
                    </div>
...
<footer class="pt-24 pb-40 mt-24 bg-[#338038] w-full">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between gap-12 md:gap-0">
        ...
        <div class="flex justify-left md:justify-start px-4">
            <img class="w-[150px] md:w-[171.59px] h-[70px] md:h-[74px]" src="./images/logo-white.png"
        ...
        <a href="#aloqa"
           class="w-[236px] lg:w-full lg:hidden flex justify-center ml-4 lg:ml-0 items-center px-5 py-4 border rounded-xl hover:bg-[#41A34C] hover:scale-105 transition-all duration-300">
            <img src="./images/tg icon.svg" alt="icon tg" class="w-6 h-6" />
            ...
            <div class="w-full md:w-[254px] px-4 lg:px-0 flex flex-col items-center md:items-end">
                ...
                <div class="w-full md:w-[179px] flex justify-start lg:justify-center md:justify-between gap-4">
                    <a class="hover:scale-110 transition-transform duration-300" href="#">
                        <img src="./images/insta icon.svg" alt="insta icon" class="w-6 h-6" />
                    </a>
                    <a class="hover:scale-110 transition-transform duration-300" href="#">
                        <img src="./images/brand-facebook.svg" alt="facebook icon" class="w-6 h-6" />
                    </a>
                    <a class="hover:scale-110 transition-transform duration-300" href="#">
                        <img src="./images/brand-youtube.svg" alt="youtube icon" class="w-6 h-6" />
                    </a>
                    <a class="hover:scale-110 transition-transform duration-300" href="#">
                        <img src="./images/brand-telegram.svg" alt="telegram icon" class="w-6 h-6" />
                    </a>
                </div>
            </div>
        </div>
