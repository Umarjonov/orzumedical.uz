                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">@Lang("base.leads")</h3>
                            </div>
                            <div class="col text-right">
                                <a href="{{ route('call_backs.index') }}" class="btn btn-sm btn-primary">See all</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach($leads as $lead)
                                    <tr>
                                        ...
                                        <td>{{$lead->name}}</td>
                                        <td>{{$lead->phone}}</td>
                                        <td>@lang("base.branches.".$lead->branch_id.".name")</td>
                                        <td>@Lang("base.$lead->status")</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
