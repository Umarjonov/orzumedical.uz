...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/comingsoon/img/favicon.png" rel="icon">
    <link href="assets/comingsoon/img/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="assets/comingsoon/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="assets/comingsoon/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
    <link href="assets/comingsoon/vendor/aos/aos.css" rel="stylesheet">

    <!-- Main CSS File -->
    <link href="assets/comingsoon/css/main.css" rel="stylesheet">
...
<header id="header" class="header d-flex align-items-center px-3 sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
        ...
        <a href="index.html" class="logo d-flex align-items-center">
            ...
            <!-- <img src="assets/comingsoon/img/logo.png" alt=""> -->
...
<!-- Vendor JS Files -->
<script src="assets/comingsoon/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="assets/comingsoon/vendor/php-email-form/validate.js"></script>
<script src="assets/comingsoon/vendor/aos/aos.js"></script>
